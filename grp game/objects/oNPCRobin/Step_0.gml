...
//check for map
	if (Index1 == 3 && !oLevelManager.ClassRoomCompleted && LevelCompleted || Index1 == 4 && !oLevelManager.ClassRoomCompleted && LevelCompleted) 
	{
		show_debug_message("dropping map");
		oLevelManager.ClassRoomCompleted = true;
