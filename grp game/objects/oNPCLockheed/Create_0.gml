...
NPCDialogue[3, 0] = "Am' actually looking fur ma SD card fur the 3D printer but A cannae fun it anywhere! Av' got a deadline the day ‘n’ A need tae print suhin' oot! A had it just before A came here, A wis starvin’ ‘n’ hid tae eat suhin' ye see, mibbe A left it in the canteen Am' no sure anymare!";
NPCDialogue[3, 1] = "I can help you look for it I have some free time today." + "04";
